""" Improved Power Aware Best Fit Decreasing based VM placement algorithms.
"""
...
@contract
def improved_power_aware_best_fit_decreasing_factory(time_step, migration_time, params):
    ...
    return lambda hosts_cpu_usage, hosts_cpu_total, \
        ...
        (improved_power_aware_best_fit_decreasing(
